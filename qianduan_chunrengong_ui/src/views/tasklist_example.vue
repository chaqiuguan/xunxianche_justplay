...
function onEdit(row) {
  ElMessage.info('编辑功能: ' + row.taskCode + '（待对接后端API）')
}
...
<template>
  <div class="app-container">
    ...
    <!-- 设置按钮 -->
    <el-button class="settings-btn" :icon="Setting" circle @click="settingsDialogVisible = true" />
    ...
    <!-- ========== 设置弹窗 ========== -->
    <el-dialog v-model="settingsDialogVisible" title="设置" width="600px" top="15vh">
      <el-form :model="settingsForm" label-width="120px">
        <el-form-item label="自动刷新">
          <el-switch v-model="settingsForm.autoRefresh" />
        </el-form-item>
        <el-form-item label="刷新间隔(秒)">
          <el-input-number v-model="settingsForm.refreshInterval" :min="5" :max="120" :step="5" />
        </el-form-item>
